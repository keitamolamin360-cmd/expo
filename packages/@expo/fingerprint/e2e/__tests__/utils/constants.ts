 ...
 */
export const E2E_TEMPLATE_SDK_VERSION = `sdk-${SDK_VERSION}`;

/**
 * The `expo` package version for E2E tests.
 * Pin the expo package version to prevent the latest version breaking snapshots.
 */
export const E2E_EXPO_PACKAGE_VERSION = `${SDK_VERSION}.0.3`;
